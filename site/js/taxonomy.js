...
export const TAXONOMY_FILES = ['axes', 'math', 'models', 'drift', 'pipelines', 'instrument', 'evidence', 'ranking', 'forecast'];

// Turns the raw JSON files into the flat shape the rest of the code uses.
export function assembleTaxonomy(files) {
  const { axes, math, models, drift, pipelines, instrument, evidence, ranking, forecast } = files;
  return {
    AXES: axes.axes,
    CODES: axes.codes,
