...
export const TAXONOMY_FILES = ['axes', 'math', 'models', 'drift', 'pipelines', 'instrument', 'evidence', 'ranking', 'forecast', 'anomaly'];

// Turns the raw JSON files into the flat shape the rest of the code uses.
export function assembleTaxonomy(files) {
  const { axes, math, models, drift, pipelines, instrument, evidence, ranking, forecast, anomaly } = files;
  return {
    AXES: axes.axes,
    CODES: axes.codes,
    ...
    // The order to show models in, fitted by bench/dcn/learn.py.
    RANKING: ranking ?? null,
    // The forecasting benchmark: which forecaster first, overall and per kind
    // of series. Generated by bench/dcn/forecast_learn.py.
    FORECAST: forecast ?? null,
    // The anomaly benchmark: which detector first, overall and per width of
    // table. Generated by bench/dcn/anomaly_learn.py.
